               ...
               <nav class="pt-4">
                <router-link to="/">
                   ...
                   <p class="pt-12 text-xs text-gray-500 uppercase font-bold">Create</p>
                    ...
                    <router-link to="/contacts/create" class="text-sm flex items-center py-2 hover:text-blue-600">
                   ...
                   <router-link to="/" class="text-sm flex items-center py-2 hover:text-blue-600">
                       ...
                       <div class="tracking-wide pl-3">Log Out</div>
                   </router-link>
               </nav>
