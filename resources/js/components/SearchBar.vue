<template>
    <div>
        ...
        <div v-if="focus" @click="focus = false" class="bg-black opacity-0 absolute left-0 right-0 top-0 bottom-0 z-10"></div>
        <div class="relative z-10">
            ...
            <input
                class="focus:outline-none focus:border-blue-500 focus:shadow focus:bg-gray-100 w-64 mr-6 bg-gray-200 border pl-8 pr-3 py-1 rounded-full text-sm"
                type="text"
                placeholder="Search...." id="searchTerm" @input="search" v-model="searchTerm" @focus="focus = true">
